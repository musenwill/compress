...
void Test() {
    ...
    {
        byte origin[16] = {0xFE, 0xFE, 0xFE, 0xFE, 0xFE, 0xFE, 0xFE, 0xFE, 0xFE, 0xFE, 0xFE, 0xFE, 0xFE, 0xFE, 0xFE, 0xFE};
        byte compressed[] = {0xFE, 16, 0xFE};
        runCase("rle", 1, origin, sizeof(origin), compressed, sizeof(compressed));
    }
    {
        byte origin[3] = {0xFE, 0xFE, 0xFE};
        byte compressed[] = {0xFE, 3};
        runCase("rle", 1, origin, sizeof(origin), compressed, sizeof(compressed));
    }
    {
